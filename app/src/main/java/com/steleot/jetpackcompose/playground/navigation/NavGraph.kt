...
object Material3NavRoutes {
    const val AlertDialog = "alert dialog#3#"
    const val BadgedBox = "badged box#3#"
    const val Badge = "badge"
    const val Button = "button#3#"
    const val CenterAlignedTopAppBar = "center aligned top app bar"
    const val ElevatedButton = "elevated button"
    const val ExtendedFloatingActionButton = "extended floating action button#3#"
    const val FilledTonalButton = "filled tonal button"
    const val FloatingActionButton = "floating action button#3#"
    const val IconButton = "icon button#3#"
    const val Icon = "icon#3#"
    ...
    const val LocalContentColor = "local content color#3#"
    ...
    const val MaterialTheme = "material theme#3#"
